...
function i4web_scripts() {
  wp_enqueue_style('i4web_main', get_template_directory_uri() . '/assets/css/main.min.css', false, '454c182b8efec8d4f99d73d815dbcd1d');
  ...
  wp_register_script('i4web_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array(), 'f7e40b745e6eb89efd71393706475eb7', true);
